...
namespace WebBanHangOnline.Areas.Admin.Controllers
{
    public class CodeDiscountsController : Controller
    {
        ...
        {
            var codeDiscounts = db.CodeDiscounts.Include(c => c.Customer);
            return View(codeDiscounts.ToList());
        }
        ...
        public ActionResult Create([Bind(Include = "Id,code,OrderId,CustomerId,isUsed,Discount,CreatedBy,CreatedDate,ModifiedDate,Modifiedby")] CodeDiscount codeDiscount)
        {
            ...
            ViewBag.CustomerId = new SelectList(db.Customers, "CustomerId", "Name", codeDiscount.CustomerId);
            return View(codeDiscount);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,code,OrderId,CustomerId,isUsed,Discount,CreatedBy,CreatedDate,ModifiedDate,Modifiedby")] CodeDiscount codeDiscount)
        {
            if (ModelState.IsValid)
            {
